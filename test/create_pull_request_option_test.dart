...
// tests for CreatePullRequestOption
void main() {
    var instance = new CreatePullRequestOption();

  group('test CreatePullRequestOption', () {
    ...
    // String base (default value: null)
    ...
    // String head (default value: null)
