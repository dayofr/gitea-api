...
class CreateBranchProtectionOption {
  ...
  static List<CreateBranchProtectionOption> listFromJson(List<dynamic> json) {
    return json == null ? List<CreateBranchProtectionOption>() : json.map((value) => CreateBranchProtectionOption.fromJson(value)).toList();
  }

  static Map<String, CreateBranchProtectionOption> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, CreateBranchProtectionOption>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = CreateBranchProtectionOption.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of CreateBranchProtectionOption-objects as value to a dart map
  static Map<String, List<CreateBranchProtectionOption>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<CreateBranchProtectionOption>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = CreateBranchProtectionOption.listFromJson(value);
       });
     }
     return map;
  }
